...
export const tasksTable = pgTable('tasks', {
  ...
  description: text('description'), // Nullable by default, matches Zod schema with .nullable()
  completed: boolean('completed').notNull().default(false), // Defaults to false for new tasks
